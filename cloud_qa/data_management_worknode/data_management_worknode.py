...
import enaml
with enaml.imports():
    from data_management_manifest import DataManagementManifest
    from data_management_gui import DataManagementGUI




class DataManagementWorknode(Worknode):
    ...
    def start(self):
        ...
        """
        self.content_def = DataManagementGUI    
        self.manifest_def = DataManagementManifest
